...
data class ToiletModel(
    ...
    val male_toilet_count: Int,
    val male_urinal_count: Int,
    val male_disabled_toilet_count: Int,
    val male_disabled_urinal_count: Int,
    val male_child_toilet_count: Int,
    val male_child_urinal_count: Int,
    val female_toilet_count: Int,
    val female_disabled_toilet_count: Int,
    val female_child_toilet_count: Int,
    ...
    val wgs84_latitude: Double,
    val wgs84_longitude: Double
) {
    companion object {
