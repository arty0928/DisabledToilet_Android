...
//    fun toggleIcon(view: View, toilet: com.dream.disabledtoilet_android.Model.ToiletModel) {
...
//    }
//
//    fun updateSave(toilet: com.dream.disabledtoilet_android.Model.ToiletModel){
...
//     * 1 : 추가 , -1 : 삭제
//     */
//    fun getCurrentSave(toilet: com.dream.disabledtoilet_android.Model.ToiletModel) : Int {
...
//    fun toggleIcon2(view: View, toilet: com.dream.disabledtoilet_android.Model.ToiletModel){
...
//
//
//    private fun updateToiletInFirebase(toilet: com.dream.disabledtoilet_android.Model.ToiletModel) {
